        ...
        <div className="gov-footer-bottom">
          <div className="page-container">
              ...
              <div className="flex items-center gap-md">
                ...
                <div>
                  ...
                  <div className="gov-footer-sub">
                    EtherBallot Autonomous Sovereign Portal • Hosted & Managed under Academic Pilot Framework
                  </div>
                </div>
              </div>
            ...
            <div className="gov-footer-meta-row">
              ...
              <span>Page Last Updated On: <strong>19 August 2026</strong> • Ledger Telemetry: Active</span>
            </div>
          </div>
        </div>
